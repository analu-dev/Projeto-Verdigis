# Generated by Django 6.1.1 on 2026-09-20 18:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('categoria', models.CharField(choices=[('objetivo', 'Objetivo do produto'), ('pratica_fds', 'Conceito aplicado de FDS'), ('beneficio', 'Ganho para o estúdio')], max_length=20, verbose_name='Categoria')),
